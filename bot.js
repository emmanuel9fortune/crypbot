...
bot.on('text', async (ctx) => {
    ...
    try {
        ...
        const imageUrl = data.image.large || data.image.small; // Use large or small image if available
        ...
        await ctx.reply('Error fetching token details. Please make sure the contract address is valid.');
    }
});
